...
def bookings():
    ...
    return render_template("bookings.html", bookings=bookings, users=users, categories=categories, number_of_bookings=number_of_bookings)
...
def add_booking():
    ...
    return render_template("add_booking.html", categories=categories)
...
def edit_booking(booking_id):
    ...
    categories = mongo.db.categories.find().sort("name", 1)
    return render_template("edit_booking.html", booking=booking, categories=categories)
